    ...
    <main className="view active">
      <div className="page-shell">
        ...
        <div className="info-page">
          <h1>Contacto</h1>
          <a className="contact-row" href="https://wa.me/5491100000000" target="_blank" rel="noopener noreferrer">
          ...
          <div className="social-row">
            <a className="social-btn" href="https://wa.me/5491100000000" target="_blank" rel="noopener noreferrer" title="WhatsApp" aria-label="WhatsApp">
          ...
          <p className="social-note">* Los links de WhatsApp e Instagram son de referencia — los cambiamos por el número y usuario reales de Gaby.</p>
        </div>
      </div>
    </main>
  );
