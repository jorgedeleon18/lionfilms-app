      ...
      <header className="topbar">
        ...
        <nav className="nav-actions">
          <div className="social-topbar">
            <a className="social-btn-sm social-whatsapp" href="https://wa.me/5491136239892" target="_blank" rel="noopener noreferrer" title="WhatsApp" aria-label="WhatsApp">
            ...
            <a className="social-btn-sm social-instagram" href="https://instagram.com/lionfilms" target="_blank" rel="noopener noreferrer" title="Instagram" aria-label="Instagram">
